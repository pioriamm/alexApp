...
abstract class Api {
  static Future<Motorista?> getMotorista(String login, String senha) async {
    try {
      var url = Uri.parse(Configuracao.uri + '/Auth/credenciais')
  ...
  static Future<List<Jornada>> getJornadas() async {
    try {
      var url = Uri.parse(Configuracao.uri + '/Jornada');
      var response = await http.get(url);
  ...
  static Future<List<Jornada>> getJornadasPorMotoristaID(
    ...
    try {
      var url = Uri.parse(
          Configuracao.uri + '/Jornada/porMotoristaID/${motoristaID}');
      var response = await http.get(url);
  ...
  static Future<List<Jornada>> getJornadasPorMotoristaIdPendentes(
    ...
    try {
      var url = Uri.parse(
          Configuracao.uri + '/Jornada/ListarTodasJornadasData/${motoristaID}');
      var response = await http.get(url);
  ...
  static Future<List<Jornada>> getJornadasPeloCondutor(
    ...
    try {
      var url = Uri.parse(Configuracao.uri + '/Jornada/{{$codigoCondutor}}');
      var response = await http.get(url);
  ...
  static Future<double> auditoriaKm(
    ...
    try {
      ...
      var url = Uri.parse(
          "${Configuracao.uri}/Jornada/auditoria/$dataInicioStr/$dataFimStr/$idMotorista");
